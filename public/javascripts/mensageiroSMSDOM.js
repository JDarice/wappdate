...
function countChar(val) {
    var totalSMSChar = 160;
    var len = val.value.length;
    var availableChar = totalSMSChar - len;
    var smsLength1 = "Ao usar este nome, ainda vão restar ";
    var smsLength2 = " caracteres para sua mensagem de SMS.";
